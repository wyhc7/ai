...
```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/linux/complete-deploy.sh | sudo bash
```

拉取更新：

```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/linux/complete-deploy.sh | sudo bash -s -- --update
```

### macOS 一键部署

```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/macos/install.sh | bash
```

拉取更新：

```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/macos/install.sh | bash -s -- --update
```

### Windows

```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/windows/start.bat -o start.bat && start.bat
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/termux/install.sh | bash
```

拉取更新：

```bash
curl -fsSL https://raw.githubusercontent.com/wyhc7/api/master/deploy/termux/install.sh | bash -s -- --update
```
